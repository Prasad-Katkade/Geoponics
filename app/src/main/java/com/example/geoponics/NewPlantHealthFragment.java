...
public class NewPlantHealthFragment extends Fragment {



    public NewPlantHealthFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_new_plant_health, container, false);
